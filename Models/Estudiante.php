<?php namespace Models;
    ...
    class Estudiante{
        ...
        public function listar(){
            $sql = "SELECT t1. *, t2.nombre as mombre_seccion FROM estudiantes t1 INNER JOIN secciones t2 ON t1.id_seccion = t2.id";
        ...
        public function view(){
            $sql = "SELECT t1. *, t2.nombre as mombre_seccion FROM estudiantes t1 INNER JOIN secciones t2 ON t1.id_seccion = t2.id WHERE t1.id = '{$this->id}'";
